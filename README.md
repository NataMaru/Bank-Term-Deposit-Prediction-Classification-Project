...
git clone (https://github.com/NataMaru/Bank-Term-Deposit-Prediction-Classification-Project)

cd Bank-Term-Deposit-Prediction-Classification-Project 

3. Download the dataset from the Kaggle link above and place `bank-additional-full.csv` in the root of the repository (the notebook expects this exact filename, semicolon-separated).
   
5. Install dependencies: pip install -r requirements.txt
   
7. Run the notebook: bank_term_deposit_classification.ipynb
